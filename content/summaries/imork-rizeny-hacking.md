---
title: "ImorK — Řízený hacking / APT"
course: imork
type: summary
tags: [apt, penetracni-testovani, fancy-bear, informacni-valka, osint]
...
| Fáze | Popis | Techniky |
|------|-------|----------|
| **1. Příprava** | Průzkum cíle, vývoj exploitů | [[osint\|OSINT]], vývoj zero-day exploitů, mapování infrastruktury |
...
- Propojení s konceptem [[informacni-valka\|informační války]] a [[sae\|bezpečnostní analýzy]]
