...
![[imork-ngn-konvergence.jpeg|Konvergence NGN — Data, Vysílání, Telekomunikace → jednotná síť]]

Sítě nové generace dle **ITU-T Y.2001**:

- **Konvergenční model** — sjednocení tří oblastí:
  1. Datové služby
  2. Broadcast (vysílání)
  3. Telekomunikace
...
- **EU Toolbox** — soubor opatření:
  1. **Strategická opatření** — koordinace na úrovni EU
  2. **Technická opatření** — konkrétní bezpečnostní mechanismy
  3. **Podpůrná opatření** — výzkum, certifikace, standardizace
