...
## Klíčové vzorce na jeden pohled

- MRCS: $\dfrac{MU_1}{MU_2} = \dfrac{U'_1}{U'_2}$ (poměr mezních užitečností = poměr cen v optimu)
- Rozpočtové omezení: $Y^* = P_1^* Q_1 + P_2^* Q_2$
- Lineární spotřeba: $C = aY + b$, redukovaný tvar C-I: $Y = \dfrac{b + I}{1 - a}$
- Multiplikátor investic / autonomní spotřeby: $Y'_I = Y'_b = \dfrac{1}{1 - a}$
